...
export const DERIVED_TYPE_METABOLISM_EXEMPTIONS = Object.freeze({
  // 原本的 excretion 一项现在是 urine 与 stool 两项，两个都要列出来，
  // 只列一个会让这些种族凭空多出半套排泄需求。
  "血族": Object.freeze(["hunger", "urine", "stool"]),
  "不死": Object.freeze(["sleep", "milk"]),
  "修炼": Object.freeze(["hunger", "urine", "stool"]),
  "魔导": Object.freeze(["sleep"]),
  "妖怪": Object.freeze(["hunger", "urine", "stool", "sleep"]),
  "神祇": Object.freeze(["hunger", "sleep"]),
  "机械": Object.freeze(["hunger", "milk"]),
  "器灵": Object.freeze(["hunger", "milk", "sleep"]),
  "星际": Object.freeze(["sleep", "milk"]),
  "变异": Object.freeze(["sleep", "hunger"]),
  "序列": Object.freeze(["sleep"]),
});
